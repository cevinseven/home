...
/** directory name(s) */
$dir = array("/Volumes/cevdev/sites/*");
...
*
*/
$icons = array( 'apple-touch-icon.png', 'favicon.ico', 'fatsamurai.png', 'rework.png');
...
//	array( 'name' => 'Tool', 'url' => 'http://example.com/' ),
	array( 'name' => 'fatsamurai', 'url' => 'http://fatsamurai.com/' ),
	array( 'name' => 'rework', 'url' => 'http://reworkcreative.com/' ),
